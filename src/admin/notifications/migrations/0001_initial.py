# Generated by Django 4.1.5 on 2023-01-17 22:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("name", models.CharField(max_length=255, verbose_name="name")),
                ("head", models.TextField(verbose_name="head")),
                ("body", models.TextField(verbose_name="head")),
            ],
            options={
                "abstract": False,
            },
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                through="notifications.TemplateUserGroup", to="notifications.usergroup"
            ),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name="user",
            field=models.ManyToManyField(
                through="notifications.UserNotification", to="notifications.customuser"
            ),
        ),
        migrations.AddField(
            model_name="notification",
            name="user_group",
            field=models.ManyToManyField(
                through="notifications.NotificationUserGroup",
                to="notifications.usergroup",
            ),
        ),
        migrations.AddField(
            ...
            name="user_group",
            field=models.ManyToManyField(
                through="notifications.UserGroupThrough", to="notifications.usergroup"
            ),
        ),
    ]
